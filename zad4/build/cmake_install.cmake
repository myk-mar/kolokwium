# Install script for directory: /home/student/Documents/kolokwium/zad4
...
file(INSTALL DESTINATION "/usr/bin" TYPE EXECUTABLE FILES "/home/student/Documents/kolokwium/zad4/build/studentapp")
  if(EXISTS "$ENV{DESTDIR}/usr/bin/studentapp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/bin/studentapp")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/bin/studentapp"
         OLD_RPATH "/home/student/Documents/kolokwium/zad4/build:"
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(WRITE "/home/student/Documents/kolokwium/zad4/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
